    ...
    <form action="{{ route('activityreport-update',$item->id) }}" method="POST" class="needs-validation" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="number" id="peserta" name="peserta" class="form-control @error('peserta') is-invalid @enderror" value="{{ old('peserta',$item->jumlah_peserta) }}" placeholder="Masukkan Jumlah Peserta">
                @error('peserta')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="kegiatan" name="kegiatan" class="form-control @error('kegiatan') is-invalid @enderror" value="{{ old('kegiatan',$item->nama_kegiatan) }}" placeholder="Masukkan Nama Kegiatan">
                @error('kegiatan')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
